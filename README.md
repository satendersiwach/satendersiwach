### Hi Developers, This is Satender Siwach 👋
...
Solution Architect and hands-on Technical Lead with extensive experience designing and delivering large-scale, cloud-native enterprise applications. Specialized in Microsoft Azure, ASP.NET Core (.NET 6–10), modern front-end frameworks, and scalable data architectures.

## Core Experience

- Solution Architect and Technical Lead with proven expertise in designing and delivering enterprise-scale applications
- Designed, developed, and maintained 5 end-to-end products from scratch, representing 100% of a startup’s product portfolio
- Led a cross-functional engineering team of 6, including senior developers, overseeing architecture, delivery, and production systems
- Specialized in Microsoft Azure, ASP.NET Core (.NET 6–10), RESTful APIs, and microservices-based architectures
- Designed hybrid data architectures using Cosmos DB, PostgreSQL, Oracle, and SQL Server
- Defined technical roadmaps, architecture standards, and solution blueprints aligned with business strategy
- Led agile development processes and collaborated with stakeholders to translate requirements into scalable solutions
- Owned production systems including monitoring, performance tuning, incident resolution, and high-availability deployments
- Implemented clean architecture, SOLID principles, dependency injection, and CI/CD pipelines
- Built modern front-end applications using Angular (latest versions), TypeScript, HTML5, CSS3, and Bootstrap
- Managed cloud and on-prem infrastructure across multiple environments (dev, staging, production)
- Hired, mentored, and scaled engineering teams, fostering strong engineering culture and delivery excellence

## Tools & Technologies

- Backend: C#, ASP.NET Core, .NET 6–10, Web API
- Frontend: Angular (latest), TypeScript, JavaScript, HTML5, CSS3
- Cloud: Microsoft Azure
- Databases: Cosmos DB, PostgreSQL, Oracle, SQL Server
- DevOps & Tools: Visual Studio, VS Code, Git, GitHub, CI/CD
